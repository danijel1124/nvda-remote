...
class LocalMachine:
	...
	def speak(
		...
		Args:
			...
			**kwargs: Additional arguments from NVDA extension points (ignored)
		...
		"""
		if self.isMuted or sequence is None:
			return
	...
	def setClipboardText(self, text: str, **kwargs) -> None:
